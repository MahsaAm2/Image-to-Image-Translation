...
The image below shows the result of t-SNE execution on real data and simulated data. Images of real cars are marked with a red star, while simulated cars are represented with a blue star.
<div style="display: flex; justify-content: center;">
    <img src="https://github.com/user-attachments/assets/3f4bc34c-bc8c-4a75-8b0b-3788a89c63a6" width="400" />
</div>

In the figure above, we can see the result of t-SNE execution on the real data and the data produced by CycleGAN. The overlap observed indicates that the simulated data is effectively mapped to the real data.
<div style="display: flex; justify-content: center;">
    <img src="https://github.com/user-attachments/assets/abae2d54-e094-40a8-9ee2-f829f22ab3fe" width="400" />
</div>
